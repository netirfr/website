...
import * as sty from "./PlasmicMenuItem.module.css"; // plasmic-import: BDik1gqhkmjQ/css
...
export type PlasmicMenuItem__ArgsType = { link?: string; label?: string };
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__kpVrv)}
        onClick={async event => {
          const $steps = {};
      ...
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox___9SY5)}>
            <div className={classNames(projectcss.all, sty.freeBox__jaeQy)}>
              <div
                className={classNames(
                  projectcss.all,
