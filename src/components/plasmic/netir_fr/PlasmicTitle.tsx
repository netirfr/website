...
import * as sty from "./PlasmicTitle.module.css"; // plasmic-import: XzqlIgKUS2Ev/css
...
export type PlasmicTitle__ArgsType = { titre?: string; lien?: string };
type ArgPropType = keyof PlasmicTitle__ArgsType;
export const PlasmicTitle__ArgProps = new Array<ArgPropType>("titre", "lien");
        ...
        {(() => {
          try {
            ...
            if (
              ...
              return "Pas s\u00fbr de trouver tes premiers clients ?";
            }
            throw e;
          }
        })()}
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicTitle__VariantsArgs, ReservedPropsType> &
