...
import * as sty from "./PlasmicMenuSection.module.css"; // plasmic-import: MlutIlVBX8lY/css
  ...
  return (
    <BaseSection
      ...
      items={renderPlasmicSlot({
        defaultContents: (
          <React.Fragment>
            <MenuItem label={"Mon espace entreprise"} link={"section-item-1"} />

            <svg
              className={classNames(projectcss.all, sty.svg__nXhSv)}
              role={"img"}
            />

            <MenuItem
              label={"Ajoutez une entreprise"}
              link={"section-item-2"}
            />
