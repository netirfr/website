...
export type TrophySvgrepoCom1SvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function TrophySvgrepoCom1SvgIcon(props: TrophySvgrepoCom1SvgIconProps) {
...
export default TrophySvgrepoCom1SvgIcon;
/* prettier-ignore-end */
