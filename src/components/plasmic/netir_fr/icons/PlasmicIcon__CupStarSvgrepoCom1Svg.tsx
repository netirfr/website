...
export type CupStarSvgrepoCom1SvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function CupStarSvgrepoCom1SvgIcon(
  props: CupStarSvgrepoCom1SvgIconProps
) {
...
export default CupStarSvgrepoCom1SvgIcon;
/* prettier-ignore-end */
