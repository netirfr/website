...
export type TaskSquareSvgrepoComSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function TaskSquareSvgrepoComSvgIcon(
  props: TaskSquareSvgrepoComSvgIconProps
) {
...
export default TaskSquareSvgrepoComSvgIcon;
/* prettier-ignore-end */
