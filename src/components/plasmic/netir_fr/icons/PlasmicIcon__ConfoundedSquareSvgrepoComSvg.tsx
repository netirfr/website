...
export type ConfoundedSquareSvgrepoComSvgIconProps =
  React.ComponentProps<"svg"> & {
    title?: string;
  };

export function ConfoundedSquareSvgrepoComSvgIcon(
  props: ConfoundedSquareSvgrepoComSvgIconProps
) {
...
export default ConfoundedSquareSvgrepoComSvgIcon;
/* prettier-ignore-end */
