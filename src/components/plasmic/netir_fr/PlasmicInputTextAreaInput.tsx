...
import * as sty from "./PlasmicInputTextAreaInput.module.css"; // plasmic-import: q95RA06_zFza/css

createPlasmicElementProxy;

export type PlasmicInputTextAreaInput__VariantMembers = {
  type: "soft" | "plain";
  flat: "top" | "right" | "bottom" | "left";
  padded: "left" | "right";
};
export type PlasmicInputTextAreaInput__VariantsArgs = {
  type?: SingleChoiceArg<"soft" | "plain">;
  flat?: MultiChoiceArg<"top" | "right" | "bottom" | "left">;
  padded?: MultiChoiceArg<"left" | "right">;
};
type VariantPropType = keyof PlasmicInputTextAreaInput__VariantsArgs;
export const PlasmicInputTextAreaInput__VariantProps =
  new Array<VariantPropType>("type", "flat", "padded");

export type PlasmicInputTextAreaInput__ArgsType = {
  value?: string;
  placeholder?: string;
  disabled?: boolean;
  readOnly?: boolean;
...
type ArgPropType = keyof PlasmicInputTextAreaInput__ArgsType;
export const PlasmicInputTextAreaInput__ArgProps = new Array<ArgPropType>(
  "value",
  "placeholder",
  "disabled",
  "readOnly",
...
export type PlasmicInputTextAreaInput__OverridesType = {
  ariaTextArea?: Flex__<typeof BaseTextArea>;
};

export interface DefaultInputTextAreaInputProps {
  value?: string;
  placeholder?: string;
  disabled?: boolean;
  readOnly?: boolean;
...
function PlasmicInputTextAreaInput__RenderFunc(props: {
  variants: PlasmicInputTextAreaInput__VariantsArgs;
  args: PlasmicInputTextAreaInput__ArgsType;
  overrides: PlasmicInputTextAreaInput__OverridesType;
  forNode?: string;
}) {
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicInputTextAreaInput__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicInputTextAreaInput__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicInputTextAreaInput__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicInputTextAreaInput__ArgProps,
          internalVariantPropNames: PlasmicInputTextAreaInput__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicInputTextAreaInput__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "ariaTextArea") {
    func.displayName = "PlasmicInputTextAreaInput";
  } else {
    func.displayName = `PlasmicInputTextAreaInput.${nodeName}`;
  }
  return func;
}

export const PlasmicInputTextAreaInput = Object.assign(
  // Top-level PlasmicInputTextAreaInput renders the root element
  makeNodeComponent("ariaTextArea"),
  {
    // Helper components rendering sub-elements

    // Metadata about props expected for PlasmicInputTextAreaInput
    internalVariantProps: PlasmicInputTextAreaInput__VariantProps,
    internalArgProps: PlasmicInputTextAreaInput__ArgProps
  }
);

export default PlasmicInputTextAreaInput;
/* prettier-ignore-end */
